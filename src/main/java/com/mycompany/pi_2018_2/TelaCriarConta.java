...
public class TelaCriarConta extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Condicao");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "PENSIONISTA", "APOSENTADO", "FUNCIONÁRIO PUBLICO" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        conta.setDivida(Double.parseDouble(jTextField4.getText()));
        conta.setCondicao(jComboBox1.getName());
        
        try {
            String sql = "INSERT INTO conta VALUES (default, '"+conta.getCpf()+"', '"+conta.getSenha()+"' , '"+conta.getRenda()+"', '"+conta.getDivida()+"')";
